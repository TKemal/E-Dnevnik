...
@WebServlet(name = "InsertTeacherServlet", urlPatterns = {"/InsertTeacherServlet"})
public class InsertTeacherServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Services.insertTeacher(new Teachers(name, hashPassword));
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertTeacherServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Uspjesno ste registrovali nastavnika sa: </h1>");
            ...
            Logger.getLogger(InsertTeacherServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
